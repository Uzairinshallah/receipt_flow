              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    (rProvider.isLoading)
                        ? const LoadingItemTile(
                            title: LocaleKeys.uploadingItem,
                          )
                        : const SizedBox(),
                    (rProvider.receiptList.isNotEmpty)
                        ? ListView.separated(
                              shrinkWrap: true,
                              itemCount: rProvider.receiptList.length,
                              separatorBuilder:
                                (BuildContext context, int index) {
                              return const Divider();
                            },
                            itemBuilder: (context, index) {
                              return ItemStatsTile(receiptModel: rProvider.receiptList[index]);
                            },
                          )
                        : Column(
                            children: [
